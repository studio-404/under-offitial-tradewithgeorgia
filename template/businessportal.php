...
<div class="container" id="container">
	...
	<div class="export_companies">
		...
		<div class="showLevel1">
			<div class="chooseMe" data-sect="dropsubSectors" data-load="lbuyandsell" data-turn="off">Buy And Sell <span class="downArrow"></span></div>
				<div class="dropsubSectors hidedUlli" style="display:none"></div>
			<div class="chooseMe" data-sect="dropproduct" data-load="ltype" data-turn="off">Type <span class="downArrow"></span></div>
				<div class="dropproduct hidedUlli" style="display:none"></div>
			<div class="chooseMe" data-sect="dropexportmarkets" data-load="lsector" data-turn="off">Sector <span class="downArrow"></span></div>
		...
		<div class="filters_div hideInMobile">
			<div class="col-sm-8 filter_cols<?=(isset($_GET['view']) && !empty($_GET['view'])) ? ' selected' : ''?>">
				...
				<ul class="dropdown-menu lbuyandsell">
			...
			<div class="col-sm-2 filter_cols<?=(isset($_GET['sector']) && !empty($_GET['sector'])) ? ' selected' : ''?>">
				...
				<ul class="dropdown-menu lsector">
