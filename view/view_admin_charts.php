...
<body>
	...
	<main>
		<div class="center">
			...
			<div class="content">
				<div class="button">
					<a href="?action=addChart"><i class="fa fa-plus-circle"></i> <span>Add</span></a>
				</div>
				<div class="wrap">
					<div class="search">
					<input type="text" class="searchTerm" value="" placeholder="Chart name">
				...
				<div id="table">
					...
					<div class="header-row row">
						<span class="cell primary">Unique Id</span>
						<span class="cell primary">Type</span>
						<span class="cell">Chart name</span>
