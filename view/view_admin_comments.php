...
<body>
	...
	<main>
		<div class="center">
			...
			<div class="content">
				<div class="button">
					<a href="?action=addComments&type=<?=$_GET['type']?>&id=<?=$_GET['id']?>&cidx=<?=$_GET['cidx']?>&super=<?=$_GET['super']?>&token=<?=$_SESSION['token']?>"><i class="fa fa-plus-circle"></i> <span>Add</span></a>
				</div>
				<div class="wrap">
					<div class="search">
					<input type="text" class="searchTerm" value="" placeholder="Component name">
				...
				<div id="table">
					...
					<div class="header-row row">
						...
						<span class="cell">Name Surname</span>
